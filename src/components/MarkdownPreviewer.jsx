...
class MarkdownPreviewer extends React.Component{
    ...
    render(){
        ...
        return(
            <div className='container-fluid grande'>
                <h1 className='text-center mt-4 mb-4'>Convert to Markdown</h1>
                <div className='row d-flex justify-content-center'>
                    <div className="col-5">
                        <h5 className='text-center'>Enter your markdown here:</h5>
                        <textarea className='form-control p-2' id='editor' value={markdown} onChange={this.handleChange}></textarea>
                    </div>
                    <div className="col-5">
                        <h5 className='text-center'>Here's the result:</h5>
